<template>
  <nav class="bg-white fixed left-0 top-0 right-0 z-50 backdrop-blur-md rounded-2xl shadow px-4 py-3 mx-24 my-5 flex items-center justify-between">
    ...
    <ul class="hidden md:flex items-center space-x-2 lg:space-x-4">
      <li>
        <router-link to="/" class="flex items-center px-4 py-2 rounded-xl bg-gray-100 text-gray-900 font-medium">
      ...
      <li>
        <router-link to="/about" class="flex items-center px-4 py-2 rounded-xl text-gray-500 hover:bg-gray-200 active:bg-gray-200 font-medium">
      ...
      <li>
        <router-link to="/education" class="flex items-center px-4 py-2 rounded-xl text-gray-500 hover:bg-gray-200 active:bg-gray-200 font-medium">
          <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
